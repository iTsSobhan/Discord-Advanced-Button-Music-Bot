    ...
    try {
        ...
        for (let i = 0; i < lyrics.length; i += 1000) {
            ...
            const embed = new Discord.MessageEmbed()
                ...
                .setThumbnail(song.user.displayAvatarURL({format:"png",dynamic: true}))
                .setFooter(`Song Requested by: ${song.user.tag}`, "https://cdn.discordapp.com/attachments/914572666604781648/928973578802692116/play-that-funky-music.gif")
                .setColor(ee.color)
                .setDescription(current)
            embeds.push(embed);
        }
